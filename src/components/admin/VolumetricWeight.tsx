  ...
  return (
    <>
      ...
      <p className="text-sm opacity-70 mb-4">
        Calculate volumetric weight (L x B x H / 5000) for standard shipping.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="form-control">
          <label className="label">
            <span className="label-text">Breadth (cm)</span>
          </label>
          <input
            type="number"
            className="input input-bordered"
      ...
      <div className="mt-6 p-4 bg-primary/10 rounded-xl text-center">
        <p className="text-sm font-semibold opacity-70 uppercase tracking-wider mb-1">
          Volumetric Weight
        </p>
