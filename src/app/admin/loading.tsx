...
/**
 * Streamed the moment this segment is requested, ahead of any data — admin screens are table/form shaped.
 *
...
export default function Loading() {
  return <CalculatorSkeleton withChart={false} pickers={4} />;
}
