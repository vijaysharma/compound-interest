    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://checkout.razorpay.com https://vercel.live; style-src 'self' 'unsafe-inline' https://accounts.google.com https://vercel.live; img-src 'self' data: blob: https://api.dicebear.com https://lh3.googleusercontent.com https://*.googleusercontent.com https://checkout.razorpay.com https://vercel.live https://vercel.com; font-src 'self' data: https://vercel.live https://assets.vercel.com; connect-src 'self' https://open.er-api.com https://api.mfapi.in https://api.worldbank.org https://oauth2.googleapis.com https://accounts.google.com https://api.razorpay.com https://lumberjack.razorpay.com https://apiv2.shiprocket.in https://api.postalpincode.in https://vercel.live wss://ws-us3.pusher.com; frame-src 'self' https://accounts.google.com https://api.razorpay.com https://vercel.live; object-src 'none'; base-uri 'self'; form-action 'self';",
          },
        ],
      },
      {
